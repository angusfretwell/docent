...
callouts: [{anchor: {capture: cap_01JZFIXTUREPROD00000000C4,kind: screenshot-region,rect: [0.493,0.278,0.063,0.043]},body: "The format switch — CSS or JSON."},{anchor: {capture: cap_01JZFIXTUREPROD00000000C4,kind: screenshot-region,rect: [0.038,0.42,0.923,0.183]},body: "The same palette, re-serialized in place."}]
---
