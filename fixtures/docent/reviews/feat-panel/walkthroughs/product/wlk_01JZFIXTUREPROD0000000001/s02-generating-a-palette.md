...
annotations: [{anchor: {capture: cap_01JZFIXTUREPROD00000000C2,fromMs: 0,kind: recording-timestamp,toMs: 900},body: "The first click replaces every swatch at once."},{anchor: {capture: cap_01JZFIXTUREPROD00000000C2,fromMs: 1500,kind: recording-timestamp,toMs: 2008},body: "By the third click the History panel has three rows."}]
---
