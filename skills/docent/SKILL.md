...
If there is already a product walkthrough for this head, skip this section. Capture is the run's most expensive phase, which is exactly why it is separable.
