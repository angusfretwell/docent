...
- **Walkthroughs only, never Findings.** Reconciliation produces tours; the review → Findings loop is `/from-docent` and `/to-docent`, separate flows (agent-integration.md §3.1).
