import { fetchExpandedFileDiff } from "@client/data/blobs";
import { useViewedState } from "@client/data/viewed";
import { CodeViewWorkerPool } from "@client/features/walkthrough-shared";
import { usePersisted } from "@client/hooks/use-persisted";
import { isExpandable } from "@client/lib/blobs";
import { themes } from "@client/lib/code-view";
import type { DriftResult } from "@client/lib/drift";
import { bodyReplaced } from "@client/lib/edge-cases";
import type { FileClass } from "@client/lib/edge-cases";
import type { FileOrder } from "@client/lib/nav";
import { toggleInSet } from "@client/lib/set";
...
import { useContextExpansion } from "./use-context-expansion";
import { useDiffFindings } from "./use-diff-findings";
import { useDiffNav } from "./use-diff-nav";
