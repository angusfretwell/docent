import { targetAnchorProps } from "@client/hooks/use-active-target";
import type { WalkthroughStep } from "@client/lib/walkthrough";
import { stepLayout, targetKey } from "@client/lib/walkthrough";
...
import { CalloutList } from "./callouts";
