...
import type { RowState } from "../components/file-tree";
import type { FileClass } from "./edge-cases";
import { autoViewed, classifyFiles } from "./edge-cases";
import type { ChangeAnchor, FileEntry, FileOrder, TreeNode } from "./nav";
import {
  buildTree,
  changeAnchors,
  filterEntries,
